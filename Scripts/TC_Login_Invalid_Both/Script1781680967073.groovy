...
// [Edge Case] Cả username và password đều sai
CustomKeywords.'com.cura.pages.LoginPage.navigateToLoginPage'()
CustomKeywords.'com.cura.pages.LoginPage.enterUsername'('InvalidUser')
CustomKeywords.'com.cura.pages.LoginPage.enterPassword'('WrongPass123')
...
WebUI.comment('[Edge Case] Cả hai sai → login bị từ chối đúng')